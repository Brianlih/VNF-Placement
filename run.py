    ...
    while itt <= seed_upper_bound:
        ...
        for nvt in range(len(number_of_VNF_types)):
            ...
            for it in range(number_of_iteration):
                ...
                #     count_of_vnf_types = [0] * number_of_VNF_types[nvt]
                ...
                #                 f_count += 1
                #                 count_2 += number_of_nodes[0]
                #             count_of_vnf_types[f_count] += 1
                #             count_2 -= number_of_nodes[0]
                #             loc -= count_2
                #             v = loc % number_of_nodes[0]
                #             # print("i,f,v: ", i,settings_per_iteration.F_i[i][f_count],v)
                #     print("count_of_vnf_types: ", count_of_vnf_types)
                # else:
                #     cplex_res = 0

                class Data:
                    num_of_VNF_types = number_of_VNF_types[nvt]
                    num_of_requests = number_of_requests[0]
...
if __name__ == "__main__":
    ...
    #     plt.ylabel('Ratio of shared VNF')
    #     plt.legend()
    #     # plt.show()
    #     current_date = datetime.datetime.now()
