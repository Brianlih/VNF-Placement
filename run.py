...
if __name__ == "__main__":
    ...
    if True:
        results = [result_mean_cplex_res_value, result_mean_improved_greedy_res_value, result_mean_greedy_res_value, result_mean_hGreedy_res_value]
        ylim = 0
        ...
        colors = ['aqua', 'deepskyblue', 'dodgerblue', 'royalblue']
