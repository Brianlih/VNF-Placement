...
if __name__ == "__main__":
    ...
    #     #         if (result_mean_sa_res_value[i] > result_mean_sa_res_value[i + 1] or
    #     #             result_mean_improved_greedy_res_value[i] > result_mean_improved_greedy_res_value[i + 1] or
    #     #             result_mean_hGreedy_res_value[i] > result_mean_hGreedy_res_value[i + 1]):
    #     #             flag = False
    #     #             break
    #     if flag:
    #         seeds.append(seed)
