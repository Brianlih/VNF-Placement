...
#     while itt <= seed_upper_bound:
    ...
    for nr in range(len(number_of_requests)):
        ...
        seeds = [413, 126, 427, 1337, 1260, 66, 1586, 2751, 2459, 3263, 3780, 4293, 3291, 3797, 4297]
        for seed in seeds:
            print("seed: ", seed)
...
# if __name__ == "__main__":
#     seed_lower_bound = 2401
#     seed_upper_bound = 2500
#     print("start")
...
#         p.start()
#         processes.append(p)
#         seed_lower_bound += 100
#         seed_upper_bound += 100
